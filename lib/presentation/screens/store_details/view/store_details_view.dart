...
import '../viewModel/stores_view_model.dart';

class StoresDetailsView extends StatefulWidget {
  const StoresDetailsView({super.key});

  @override
  State<StoresDetailsView> createState() => _StoresDetailsViewState();
}

class _StoresDetailsViewState extends State<StoresDetailsView> {
