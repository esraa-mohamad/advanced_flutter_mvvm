...
class _$RegisterObjectImpl implements _RegisterObject {
  ...
  @override
  String toString() {
    return 'RegisterObject(email: $email, password: $password, userName: $userName, mobilePhone: $mobilePhone, profilePicture: $profilePicture, countryMobileCode: $countryMobileCode)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, userName,
      mobilePhone, profilePicture, countryMobileCode);
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      required final String countryMobileCode}) = _$RegisterObjectImpl;
